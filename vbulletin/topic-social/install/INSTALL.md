...
5. Configure Telegram, X, Cutt.ly, monitored forum IDs, and message template.

## Important

The product XML in this repository is a draft scaffold and may need adjustment to match the exact hook names and XML schema expected by your vBulletin 4.2.5 installation.
